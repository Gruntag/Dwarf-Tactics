...
const endGame = (result: Phase) => {
  ...
  if (result === "victory") {
    toast({
      title: "Minecart Extraction Complete",
...
const overlayDescription = computed(() => {
  switch (phase.value) {
    ...
    default:
      return "Guide Gruntag's minecart convoy through the tunnels. Gather treasure carts, avoid crashing into the cavern walls or yourself, and collect 22 carts to claim victory.";
  }
});
